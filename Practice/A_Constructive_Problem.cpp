...
void solve() {
    ...
    // int target = mex + 1;
    // // two possibilities
    // // either mex + 1 already present
    // if (tf.count(mex + 1)) {
    //     // replace all mex + 1 ' s with mex
    //     // 1st mex+1 ................. last mex + 1
    //     int left = 0, right = n - 1;
    //     for (left; left < right; left++) {
    //         if (v[left] == mex + 1) break;
    //     }
    //     for (right; right >= left; right--) {
    //         if (v[right] == mex + 1) break;
    //     }
    ...
    // if (mex < mx) {
    //     // we have to insert mex in the array
    //     // all elements greater than mex should be euqal to mex
    //     int oz = sz(ltm);
    //     int l = 0, r = n - 1;
    //     for (l; l < r; l++) {
    //         if (v[l] > mex) break;
    ...
    // }
    // if (prev_mex > mx) {
    //     // we have to insert prev_mex at some position
    //     vi f = frequency(v);
    //     if (maxel(f) > 1) {
    //         cout << "YES" << endl;
    //     } else
    ...
    // // we don't have to touch prev_mex
    // int l = 0, r = n - 1;
    // for (l; l < r; l++) {
    //     if (v[l] > prev_mex) {
    //         break;
    ...
    //     v[r--] = prev_mex;
    // }
    // int present_mex = cur_mex(v, n);
    // if (present_mex == prev_mex + 1) {
    //     cout << "Yes" << endl;
    // } else
    //     cout << "No" << endl;
    // // print(v);

...
void test() {
    int oddxor = 0;
    for (int i = 1; i <= 100900; i += 2) {
        oddxor = oddxor ^ i;
    }
    int evenxor = 0;
    for (int i = 2; i <= 100900; i += 2) {
        evenxor = evenxor ^ i;
    }
    cout << ~(oddxor) << " " << ~(evenxor) << endl;
}
...
void ritik() {
    ...
    //     // if n is odd last ke 3 element chorke
    //     // if n is even last ke 2 elements chorke
    //     cout << i << " ";
    //     if (i & 1) {
    //         c ^= i;
    //     } else {
    ...
    // }
    // cout << (d ^ x) << " " << (c ^ x) << " " << x << " ";
    // // print last ke bache hue elements
    // if (n & 1) {
    //     cout << 0;  // 0 won't change any values
    // }

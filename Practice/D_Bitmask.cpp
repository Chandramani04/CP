...
void solve() {
    ...
    int n;
    cin >> n;
    string number = binary_to_string(n);
    // 10010
    //   100
    // 11010
    ...
    if (sz(number) < sz(s)) {
        ...
        // 10110
        // 00100
        int dif = sz(s) - sz(number);
        rep(i, 0, dif) {
            number = '0' + number;
        }
    } else if (sz(number) > sz(s)) {
        int dif = sz(number) - sz(s);
        rep(i, 0, dif) {
            s = '0' + s;
        }
    }
    ...
    // } else if (siz == n) {
    //     string temp = binary_to_string(on);
    //     for (int i = sz(temp) - 1; i >= 0; i--) {
    //         if (s[i] == '?') {
    //             s[i] = temp[i];
    //         }
    //     }
    //     int ans = string_to_binary(s);
    //     if (ans > on) {
    //         cout << -1 << endl;
    //     } else
    //         cout << ans << endl;

...
void solve() {
    ...
    /*
    mark                               v = {4} , psum(4)  range = {{1,4}}
   1. [1,4] markmark
   lb(psum,1) = 1 ,lb(psum,4) = 1
   1%v[1] = 1 , 4%v[1] = 0=v[1] =>
   [1 4] -> v = {4,4} , psum = {4,8} , range = {{1,4},{1,4}}




   2. [1,4] markmark ,lb(psum,1)=1,
    [5,7] markmark ,lb(psum,5)=2,
    lb(psum,7) = 2 ,
    5-=v[2] = 1 , 7-=v[2] = 3 =>[1,3] == markmarkmar , v = {4,4,3} , psum = {4,8,11} ,range = {{1,4},{1,4},{1,3}}

   3. [3,8] :
    lb(psum,3) = 1 ,lb(psum,8) = 2 ,
    3%v[1] = 3 , 8%v[2] = 0= 4 => [3(v[1]),4(v[2])] = markmarkmarrkmark ,
    v = {4,4,3,6} , psum = {4,8,11,17} , range = {{1,4},{1,4},{1,3},{3,4}}
    ...
    */
    ...
    while (q--) {
        ...
        while (pos > n) {
            int idx = lb(psum, pos);
            int actual_pos = psum[idx] - pos;
            pos = v[idx].second - actual_pos;
        }
        cout<<s[pos]<<endl;
    }
}

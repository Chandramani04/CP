...
void solve() {
    ...
    int L = -1e9, R = 1e9;
    /*
        match ith choclate source to ith cake
    */
    // print(a);
    // print(b);
    rep(i, 0, n) {
        L = max(L, a[i] - w - b[i] + h);  // left of choclate and left of cake
        R = min(R, a[i] + w - b[i] - h);  // right of choclate and right of cake
        cout << a[i] - w << " " << b[i] - h << " " << L << " " << a[i] + w << " " << b[i] + h << " " << R << endl;
    }
    ...
    //     cake[i].ss = a[i] + w;
    // }
    // vector<pair<int, int>> chocolate(n);
    // rep(i, 0, n) {
    //     chocolate[i].ff = b[i] - h;
    //     chocolate[i].ss = b[i] + h;
    // }
    // if (cake[0].first > chocolate[0].first) {
    //     // shift to right
    //     int dif = cake[0].first - chocolate[0].first;
    //     int temp = chocolate.back().second + dif;
    //     // if (temp > cake.back().second) {
    //     //     cout << "NO" << endl;
    //     //     return;
    //     // }
    //     // add dif to all chocolates
    //     rep(i, 0, n) {
    //         chocolate[i].ss += dif;
    //         chocolate[i].ff += dif;
    //     }
    ...
    // else if (chocolate.back().second > cake.back().second) {
    //     int dif = chocolate.back().second - cake.back().second;

    //     int temp = chocolate[0].first - dif;
    //     // if (temp < cake[0].first) {
    //     //     cout << "NO" << endl;
    //     //     return;
    //     // }
    //     rep(i, 0, n) {
    ...
    //     }
    // }
    // int rightshift = -1e9, leftshift = 1e9;
    // rep(i, 0, n) {
    //     rightshift = max(rightshift, chocolate[i].second - cake[i].second);
    //     leftshift = min(leftshift, chocolate[i].first - cake[i].first);
    // }

...
void solve() {
    ...
    while (m--) {
        int def, atk;
        cin >> def >> atk;
        int idx = lower_bound(all(v), def) - v.begin();
        // case 1 : v[idx] goes for attack , rest defends
        ...
        int defend = tsum - attack;
        int total_coin = max(0ll, def - attack) + max(0ll, atk - defend);
        case1 = total_coin;

        // case 2 : v[idx-1] goes for attack , rest defends
        ...
        defend = tsum - attack;
        total_coin = max(0ll, def - attack) + max(0ll, atk - defend);
        case2 = total_coin;

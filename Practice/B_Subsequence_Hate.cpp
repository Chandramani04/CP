...
void solve() {
    ...
    cin >> str;
    string s = str;
    // make s of them form 0000000001111111111
    int n = str.size();
    ...
    rep(i, 0, n) {
        ...
        // to convert 11110000 , chnage all done zeros to 1 and all future ones to zero
        // done zeros = done0 , future ones = total ones- done ones

        // to convert 0000000111111, change all done ones to 0 and all future zeros to 1
        // done ones = done1 , future zeros = total zeros - done zeros
        ans = min(ans, min(done0 + c1 - done1, done1 + c0 - done0));
    }
    cout << ans << endl;
}
signed main() {

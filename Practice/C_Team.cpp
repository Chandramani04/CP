...
void solve() {
    ...
    int maxC1Possible = 2 * c0 + 2;
    int minC1Possible = c0 - 1;

    // no of 2size 1's
    int oneBlocks = c1 / 2 + c1 % 2;

    int maxC0Possible = oneBlocks + 1;
    int minC0Possible = oneBlocks - 1;

    // cout<<maxC1Possible<<" "<<minC1Possible<<" "<<maxC0Possible<<" "<<minC0Possible<<endl;

    // if ((c1 > maxC1Possible or c1 < minC1Possible) or (c0 > maxC0Possible or c0 < minC0Possible)) {
    //     cout << -1 << endl;
    //     return;
    // }
    ...
    // if (c0 <= c1) {
    //     int req = c0;
    //     // req = 0 case is handled above
    //     string z = "0";
    //     string o = "1";
    //     // after utilising req 0's we will have c1-req 1's left
    //     int uti = c1 / req;
    //     int rem = c1 % req;
    //     cout<<"uti = "<<uti<<endl;
    //     cout<<"rem = "<<rem<<endl;

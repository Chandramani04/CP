...
/*
data types supported by debug template :
primitive data types : int, long long, char, bool, string
iterable data types : vector, set , unordered_set, multiset, unordered_multiset
, map , multimap, unordered_map, unordered_multimap, priority_queue , deque,
bitset

  🔢 Primitive: int, char, bool, long long int etc.

  📚 STL: pair, tuple, vector, set, oset, map, omap, stack, queue,
priority_queue, bitset etc.

  📦 Arrays of all datatypes: int arr[], bool arr[], vector<int> adj[] etc.

  🧩 Matrix: int dp[100][200], vector<vector<bool>> vis(100, vector<bool> (200,
0)) etc.
  ...
  🤯 Even nested datatypes like map<string,
   vector<pair<char , unordered_set<long long>>>> WHATTT;.

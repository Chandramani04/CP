    ...
    */
    ...
    void solve() {
        ...
        properties of beautiful array :
            1. v[0] = v[n-1]
            2. every non v[0] can be converted to v[0] =>
                if a[i] != v[0]   then there must be a configuation of following form
                    v[i-1] = v[0]    and  v[i+1] = v[0]


            so if we remove either sides of #v[0]'s for a v[i]!=v[0] , array will become ugly
        */
        vector<pii> store;
        pii temp = {v[0], 1};

...
void solve() {
    ...
    /*
        concept =>
            3 length ke subarray ka median ko hm pura array me replace kr skte hain 
            a1 a2 a3 => let x be median  then a1 = x , a2 = x a3 = x  , 
            x x x a4 a5 s6 
            now select a2 a3 a5 as subarray => x/a4, x, x/a4 => again x will be the median and a4 will become x 
            similarly we can replace all the elements of the array with the median of the subarray of length 3

            so we can iterate over all the subarrays of length 3 and store the second largest element of each subarray and then take the maximum of all the second largest elements
    */
    if (n == 2) {
        cout << minel(v) << endl;
    } else {

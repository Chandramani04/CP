...
void solve() {
    ...
    cin >> n >> m;
    input(v, n);
    // Anna turn => choose and element and reverse it's digits 
    // try to choose a number whose last digits is as close to 9 as possible 
    // Sasha turn => choose two elements and add them string wise 
    // try to choose two two largest numbers 
}
signed main() {
    fastio();

...
void solve() {
    ...
    while (high - low > 1) {
        ...
        // we can use maximum mid turns to kill the monster
        int totalDamage = firstTurn;
        rep(i, 0, n) {
            int availTurns = (mid - 1) / cooldown[i];
            totalDamage += availTurns * damage[i];
        }
